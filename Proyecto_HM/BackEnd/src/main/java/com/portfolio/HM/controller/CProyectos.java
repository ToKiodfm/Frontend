...
import com.portfolio.HM.Dto.DtoProyectos;
import com.portfolio.HM.Security.Controller.Mensaje;
import com.portfolio.HM.entity.Proyectos;
import com.portfolio.HM.service.SProyectos;
...
public class CProyectos {
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody DtoProyectos dtoproyectos){
        ...
        if (sProyectos.existsByNombreP(dtoproyectos.getNombreP())&& sProyectos
                .getByNombreP(dtoproyectos.getNombreP()).get().getId() !=id ){
            return new ResponseEntity (new Mensaje("Ese nombre ya existe"), HttpStatus.BAD_REQUEST);
        }
        if(StringUtils.isBlank(dtoproyectos.getNombreP())){
            return new ResponseEntity (new Mensaje("El nombre es obligatorio"), HttpStatus.BAD_REQUEST);
